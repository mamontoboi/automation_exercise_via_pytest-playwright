...
class HomePage(BasePage, SubscriptionMixin):
    ...
    CART_BUTTON = {"role": "link", "name": "Cart"}
    RECOMMENDED_ITEMS_CAROUSEL = "#recommended-item-carousel"
    RECOMMENDED_SECTION_HEADING = {"role": "heading", "name": "recommended items"}
    ...
    def go_to_cart(self):
        ...
        self.page.get_by_role(**self.CART_BUTTON).click()
    ...
    def is_recommended_section_visible(self):
        ...
        expect(self.page.get_by_role(**self.RECOMMENDED_SECTION_HEADING)).to_be_visible()
    ...
    def add_first_recommended_to_cart(self):
        ...
        self.page.locator(self.RECOMMENDED_ITEMS_CAROUSEL).get_by_text("Add to cart").first.click()
